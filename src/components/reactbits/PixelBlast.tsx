...
interface PixelBlastProps {
  ...
  /** Size of each pixel in CSS pixels */
  pixelSize?: number;
  /** Base colour (hex string) */
  color?: string;
  className?: string;
  ...
  patternScale?: number;
  /** Density of pixels (0-1) */
  patternDensity?: number;
  /** Enable liquid-distortion post-processing */
  liquid?: boolean;
  /** Strength of liquid distortion */
  liquidStrength?: number;
  /** Radius multiplier for liquid touch brush */
  liquidRadius?: number;
  /** Random size jitter per pixel */
  pixelSizeJitter?: number;
  /** Show click/tap ripple waves */
  enableRipples?: boolean;
  /** Intensity multiplier for ripple waves */
  rippleIntensityScale?: number;
  /** Thickness of the ripple ring */
  rippleThickness?: number;
  /** Speed of the ripple expansion */
  rippleSpeed?: number;
  /** Oscillation speed for liquid wobble */
...
/* ------------------------------------------------------------------ */
/*  Touch-texture helper (liquid mode only)                            */
/* ------------------------------------------------------------------ */
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        if (liquidEffect)
          liquidEffect.uniforms.get("uTime")!.value =
            uniforms.uTime.value;

        if (composer) {
          if (touch) touch.update();
          composer.passes.forEach(
            (p: { effects?: Effect[]; renderToScreen: boolean }) => {
      ...
      /* ---- hot-update uniforms without recreating context ---- */
      const t = threeRef.current!;
